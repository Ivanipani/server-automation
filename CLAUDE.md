...
5. `just disk-plan` — read-only: dump every physical host's disks (hypervisors + workers) + paste-ready `storage.disks` skeleton. Run after any disk add/swap
